...
//        {
//            DirectoryInfo directoryInfo = new(@"\\192.168.188.123\scoringdm2022\tracks\work\flight_03");
...
//            [
//                CoordinateHelpers.ConvertUTMToLatitudeLongitudeCoordinate("32U", 624019, 5570870),//Goal Task8
//                CoordinateHelpers.ConvertUTMToLatitudeLongitudeCoordinate("32U", 622102, 5571266),//Goal Task9+10
//                CoordinateHelpers.ConvertUTMToLatitudeLongitudeCoordinate("32U", 619586, 5571709),//Goal Task11
//            ];
...
//            using (StreamWriter writer = new(@"C:\Temp\F[3]_LaunchChecks.csv"))
//            {
...
//            using (StreamWriter writer1 = new(@"C:\Temp\F[3]_Task9_Results.csv"))
//            {
...
//            donutTask.SetupDonut(12, 1, 3, 1000, 2000, 0, 10000, true, [declarationToGoalDistanceRule]);

//            using StreamWriter writer2 = new(@"C:\Temp\F[3]_Task12_Results.csv");
...
//        {
//            DirectoryInfo directoryInfo = new(@"\\192.168.188.123\scoringdm2022\tracks\work\flight_04");
//            FileInfo[] files = directoryInfo.GetFiles("*.igc");
//            List<Track> tracks = [];
//            foreach (FileInfo fileInfo in files)
//            {
...
//            using StreamWriter writer = new(@"C:\temp\F[4]_Task14_Results.csv");
...
//                List<Declaration> validGoals = [];
//                List<double> distancesGoalToILP = [];
//                List<double> distancesDecToGoal = [];
...
//                        else
//                        {
//                            Coordinate validGoalWithHeight = new(validGoal.DeclaredGoal.Latitude, validGoal.DeclaredGoal.Longitude, CoordinateHelpers.ConvertToMeter(1500), CoordinateHelpers.ConvertToMeter(1500), validGoal.DeclaredGoal.TimeStamp);
...
//                List<(string utmZone, int easting, int northing)> validGoalsUTM = [];
...
//            DirectoryInfo directoryInfo = new(@"\\192.168.188.123\scoringdm2022\tracks\work\flight_05");
...
//            using (StreamWriter writer = new(@"C:\temp\Fight5_ILPChecks.csv"))
//            {
...
//                foreach (Track currentTrack in tracks)
//                {
//                    writer.WriteLine(Flight5ILPCheck(currentTrack, [goalTask15, goalTask16, goalTask17, goalTask18, goalTask19A, goalTask19B]));
//                }

//            }

//            using (StreamWriter writer15 = new(@"C:\temp\F5_Taks15_results.csv"))
//            {
...
//            using (StreamWriter writer16 = new(@"C:\temp\F5_Taks16_results.csv"))
//            {
...
//            using (StreamWriter writer17 = new(@"C:\temp\F5_Taks17_results.csv"))
//            {
...
//            using (StreamWriter writer18 = new(@"C:\temp\F5_Taks18_results.csv"))
//            {
...
//            using (StreamWriter writer19 = new(@"C:\temp\F5_Taks19_results.csv"))
//            {
...
//            using (StreamWriter writer20 = new(@"C:\temp\F5_Taks20_results.csv"))
//            {
...
//                foreach (Track currentTrack in tracks)
//                {
//                    writer20.WriteLine(CalculateTask20(currentTrack, [goalTask15, goalTask16, goalTask17, goalTask18, goalTask19A, goalTask19B]));
//                }
//            }

//            using StreamWriter writer21 = new(@"C:\temp\F5_Taks21_results.csv");
...
//            foreach (Track currentTrack in tracks)
//            {
//                writer21.WriteLine(CalculateTask21(currentTrack, [goalTask15, goalTask16, goalTask17, goalTask18, goalTask19A, goalTask19B]));
//            }
//        }
...
//            {
//                (string utmZone, int easting, int northing) = CoordinateHelpers.ConvertLatitudeLongitudeCoordinateToUTM(launchPoint);

//                List<(string utmZone, int easting, int northing)> goalsUTM = [];
...
//                return string.Join(',', track.Pilot.PilotNumber, easting, northing, launchPoint.TimeStamp.ToString("HH:mm:ss"), goalChecks);
//            }
//            else
//            {
...
//        {
//            List<Declaration> declarations = [.. track.Declarations.Where(x => x.GoalNumber == goalNumber).OrderByDescending(x => x.PositionAtDeclaration.TimeStamp)];

//            string comment = string.Empty;
//            double result = double.NaN;
//            Declaration validDeclaration = null;
//            double distanceBetweenPositionOfDeclarationAndDeclaredGoal = double.NaN;
//            List<double> distanceToOtherGoals = [];
