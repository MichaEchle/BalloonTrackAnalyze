...
public abstract class TaskPDDounat : Task
{
    ...
    protected abstract bool validateStartPoint();
    ...
    public override void Score(Track track, ref string comment, out double result)
    {
        ...
        {
            result = Double.MinValue;
            comment += "No Valid-Declaration at slot " + declerationNumber() + " | ";
            return;
        }
        ...
        if (validateStartPoint() && declarationPosition.TimeStamp < startPoint.TimeStamp)
        {
