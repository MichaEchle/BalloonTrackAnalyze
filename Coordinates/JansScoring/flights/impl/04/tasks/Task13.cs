...
public class Task13 : Task
{
    ...
    public override Coordinate[] goals()
    {
        return new[]
        {
            CoordinateHelpers.ConvertUTMToLatitudeLongitudeCoordinate("32U", 0476001, 5367440,CoordinateHelpers.ConvertToMeter(1759)),
            CoordinateHelpers.ConvertUTMToLatitudeLongitudeCoordinate("32U", 0475872, 5367551,CoordinateHelpers.ConvertToMeter(1789)),
        };
    }
