...
public class Task02 : Task
{
    ...
    public override Coordinate[] goals()
    {
        return new[]
        {
            CoordinateHelpers.ConvertUTMToLatitudeLongitudeCoordinate("32U", 491040, 5370483,
                CoordinateHelpers.ConvertToMeter(1453)),
            CoordinateHelpers.ConvertUTMToLatitudeLongitudeCoordinate("32U", 490623, 5369428,
                CoordinateHelpers.ConvertToMeter(1563)),
            CoordinateHelpers.ConvertUTMToLatitudeLongitudeCoordinate("32U", 490419, 5368195,
                484),
        };
    }
