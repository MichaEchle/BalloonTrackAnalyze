...
public class Task23 : Task
{
    ...
    public override string[] score(Track track)
    {
        ...
        {
            return new[] { "No Result", "No Marker in 2" };
        }
        ...
        double declaredGoalAltitude = flight.useGPSAltitude()
            ? declaration.DeclaredGoal.AltitudeGPS
            : declaration.DeclaredGoal.AltitudeBarometric;
        double declarationAltitude = flight.useGPSAltitude()
            ? declaration.PositionAtDeclaration.AltitudeGPS
