...
/// <summary>
/// Constraint that evaluates 2D (horizontal) distance targets against minimum and maximum distance requirements.
/// </summary>
/// <remarks>
/// <para>
/// This constraint checks whether the 2D distance from a target coordinate to one or more reference coordinates
/// falls within a specified range. Distance is calculated using Haversine (great-circle) method.
...
{
	/// <summary>Gets the list of reference coordinates used for distance calculations.</summary>
	/// <remarks>
	...
	/// <summary>Gets the minimum allowed 2D distance in meters, or <see cref="double.NaN"/> if not set.</summary>
	...
	/// <summary>Gets the maximum allowed 2D distance in meters, or <see cref="double.NaN"/> if not set.</summary>
	...
	/// <summary>
	/// Checks whether a target coordinate has a distance infringement and calculates the amount.
	/// </summary>
	...
	/// <summary>
	/// Converts a distance infringement amount to a penalty value.
	/// </summary>
	/// <remarks>
