...
internal static class ProhibtedZoneChecker
{
    ...
    private static void CheckProhibitedZone(ProhibitedZone prohibitedZone, Track track, out List<Coordinate> coordinatesInZone, out TimeSpan timeInZone, out int penalties)
    {
        ...
        penalties = prohibitedZone.TypeOfZone switch
        {
            ...
            ProhibitedZoneType.Yellow => CalulcateYellowPZPenalties(prohibitedZone, coordinatesInZone),
    ...
    private static int CalulcateYellowPZPenalties(ProhibitedZone prohibitedZone, List<Coordinate> coordinatesInZone)
    {
        int penalties = 0;
        switch (prohibitedZone.ZoneDefinition)
        {
